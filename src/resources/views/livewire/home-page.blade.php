<div class="min-h-screen bg-gray-950 text-white">
    ...
    <section class="min-h-screen flex items-center px-6 max-w-7xl mx-auto">
        ...
        <div class="flex-1 space-y-6">
            ...
            <p class="text-gray-400 leading-relaxed max-w-lg text-lg border-l-2 border-indigo-500/50 pl-4">
                {{ $profile?->bio ?? 'Bio singkat lo di sini.' }}
            </p>

            {{-- CTA BUTTONS --}}
            <div class="flex gap-4 flex-wrap" x-data="{ hoveredBtn: null }">
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ $profile->github }}" target="_blank"
                   ...
                   :class="hovered ? 'border-indigo-500 text-indigo-400 bg-indigo-500/10' : 'border-gray-700 text-gray-400'"
                   class="w-11 h-11 flex items-center justify-center border rounded-xl transition-all duration-200">
                ...
                <a href="{{ $profile->linkedin }}" target="_blank"
                   ...
                   @mouseenter="hovered = true"
                   @mouseleave="hovered = false"
                   :class="hovered ? 'border-blue-500 text-blue-400 bg-blue-500/10' : 'border-gray-700 text-gray-400'"
                   class="w-11 h-11 flex items-center justify-center border rounded-xl transition-all duration-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex justify-center">
            <div class="relative">
                ...
                <div class="relative w-80 bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden shadow-2xl shadow-indigo-500/10">
                ...
                <template x-for="filter in filters" :key="filter">
                    <button
                        ...
                        :class="activeFilter === filter
                            ...
                            : 'bg-transparent text-gray-400 border-gray-700 hover:border-indigo-500 hover:text-white'"
